...
| `CTL-12` | Harness adversario, métricas, regresión y revisión independiente | `PARCIAL` | `A/R ACT-02`; `R REV-01` solo para revisión independiente | `AC-PI-01`, `AC-PI-02`, `AC-PI-03`, `AC-JB-01`, `AC-JB-02`, `AC-EX-01`, `AC-EX-02`, `AC-EX-03`, `AC-TOL-01`, `AC-TOL-02`, `AC-TOL-03`, `AC-TOL-04`, `AC-TOL-05`, `AC-DOS-01`, `AC-DOS-02`, `AC-DOS-03`, `AC-SC-01` | `CMP-07` conecta 14 fixtures PI/JB/EX/TOL con oráculos separados; `CMP-08` fija la baseline histórica y PGS-05-M01 repite los mismos 14 IDs contra el candidato endurecido exacto con evidencia neutral e íntegra | `tests/test_adversarial_corpus.py::test_manifest_fixes_scope_counts_and_partial_test_wiring`<br>`tests/test_adversarial_baseline.py::test_baseline_reproduces_one_residual_and_sanitizes_observations`<br>`tests/test_adversarial_retest.py::test_versioned_retest_is_reviewed_sanitized_and_internally_consistent` | Cuatro casos DOS/SC siguen inertes, M01 no calcula tasas o llamadas y `REV-01` no está asignado | PGS-05-M02 a M09 y PGS-07-M01 a M06 |
...
`evaluations/adversarial-retest-v1/`. El siguiente tratamiento es medir tasas
y llamadas en PGS-05-M02 sin reinterpretar M01.
