...
descriptiva en `evaluations/operational-metrics-v1.json`. El siguiente
tratamiento es registrar controles fallidos, bypasses y resultados negativos
en PGS-05-M05.
