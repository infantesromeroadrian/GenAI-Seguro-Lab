...
| `CTL-05` | Validación de entradas, salidas y argumentos; allowlist de herramientas | `PARCIAL` | `A/R ACT-02` | `AC-JB-02`, `AC-EX-01`, `AC-EX-02`, `AC-TOL-01`, `AC-TOL-02` | Pydantic, nombre exacto, subconjunto por incidente, cardinalidad y terminación acotada protegen el flujo actual; `CMP-07` verifica nombre prohibido, cardinalidad, duplicados, recursión y rechazo genérico de conocimiento. Faltan política de salida y validación del futuro modelo real | PGS-04-M02, PGS-04-M05 y PGS-05 |
...
estructural de dominios de confianza al flujo ordinario; el siguiente
tratamiento es la validación y las allowlists de PGS-04-M02.
